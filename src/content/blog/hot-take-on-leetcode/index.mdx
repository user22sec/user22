...
Give any LeetCode problem to AI, and it can solve it in a couple of minutes.
...
![leetcode-vs-real-meme.png](./assets/leetcode-vs-real-meme.png)
...
- Setting cool wallpapers and screen savers in your old windows laptop was fun.
...
![pasted-image-20260309222938.png](./assets/pasted-image-20260309222938.png)

You have two choices

Follow the boring manual and be the 1001st guy, who did the same thing successfully.

Or take a leap of faith on what your heart says. Because in the end, all that matters is that you had fun along the way.
